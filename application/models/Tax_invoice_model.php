...
class Tax_invoice_model extends MY_Model
{
    /**
	...
	{
		parent::__construct("tax_invoice");
        $this->tables['name'] = "tax_invoice";
	}
	/**
	 * create
	 *
	 ...
	 * @author madukubah
	 */
	public function tax_invoices( $purchase_order_id = NULL  )
    {
		if( isset( $purchase_order_id ) )
		{
			$this->where($this->tables['name'].'.purchase_order_id', $purchase_order_id);
		}
		$this->fetch_data(  );
		return $this;
	}
