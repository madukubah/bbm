...
class Do_report_model extends MY_Model
{
    /**
	...
	{
		parent::__construct("do_report");
        $this->tables['name'] = "do_report";
	}
	/**
	 * create
	 *
	 ...
	 * @author madukubah
	 */
	public function do_report( $id = NULL  )
    {
		if (isset($id))
		{
	 ...
	 * @author madukubah
	 */
	public function do_reports( $delivery_order_id )
    {
