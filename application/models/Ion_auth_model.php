...
class Ion_auth_model extends CI_Model
{
	 ...
	 * @author Ben Edmunds
	 */
	public function last_user_id( $group_id = NULL )
	{
		$this->trigger_events('user');

		// if no id was passed use the current users id

		$this->select( $this->tables['users'].".id" );
		$this->select( $this->tables['users'].".username" );
	...
	public function delete_user($id)
	{
		...
		$this->company_model->delete_companies( $id );
	...
	public function set_session($user)
	{
		...
		$session_data = [
		    ...
		    'last_check'           => time(),
		    'user_profile_name'    => $user->{$this->identity_column},
