...
class Do_news_and_tax_model extends MY_Model
{
    /**
	...
	{
		parent::__construct("do_news_and_tax");
        $this->tables['name'] = "do_news_and_tax";
	}
	/**
	 * create
	 *
	 ...
	 * @author madukubah
	 */
	public function do_news_and_tax( $id = NULL  )
    {
		if (isset($id))
		{
	 ...
	 * @author madukubah
	 */
	public function do_news_and_taxes( $delivery_order_id = NULL  )
    {
		if( isset( $delivery_order_id ) )
		{
			$this->where($this->tables['name'].'.delivery_order_id', $delivery_order_id);
		}
		$this->fetch_data(  );
		return $this;
	}
