 ...
 */
$config['username_prefix'][1]			  ="ADMIN_";//admin
$config['username_prefix'][2]			  ="111";//customers
$config['username_prefix'][3]			  ="DRV_";//'drivers'
$config['site_title']                 = "Example.com";       // Site Title, example.com
$config['admin_email']                = "admin@example.com"; // Admin Email, admin@example.com
$config['default_group']              = 'customers';           // Default group, use name
...
$config['upload']['max_size']								        = 20000000;