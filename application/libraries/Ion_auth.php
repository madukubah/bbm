...
class Ion_auth
{
	...
	public function get_form_data( $user_id = -1 )
	{
		...
		$data['identity'] = array(
			...
			'class' => 'form-control',
			'value' => $this->form_validation->set_value('identity', $this->identity	),
		);
		...
		$data['email'] = array(
			...
			'placeholder' => "Email",
			'class' => 'form-control',
			'value' => $this->form_validation->set_value('email', $this->user_email),
		);
		$data['phone'] = array(
			'name' => 'phone',
			'id' => 'phone',
		...
		$data['submit'] = array(
			'data' => 'submit',
			'value' => $button_label[ $this->router->fetch_method() ] ,
			'id' => 'submit',
			'type' => 'submit',
