  ...
  <section class="content">
    ...
    <div class="invoice">
        <div class="row">
              ...
              <div class="col-xs-2">   
                  <!--  -->
                  <button type="submit" <?php echo ( $invoice->status == 2 )?'disabled':'' ?> class="btn btn-success" data-toggle="modal" data-target="#paid_off" ><i class="ace-icon fa fa-flag bigger-120 red"></i> Lunas</button>
                    <!-- edit_category-->
                  <div class="modal fade" id="paid_off" role="dialog">
                      <div class="modal-dialog">
                      <!-- Modal content-->
                      <div class="modal-content">
                          <?php echo form_open("admin/invoice/paid_off");?>
                          <div class="modal-header">
                          <button type="button" class="close" data-dismiss="modal">&times;</button>
                          <h4 class="modal-title">Lunas</h4>
                          </div>
                          <div class="modal-body">
                              <div class="alert alert-success">anda Yakin ?</div>
                          </div>
                          <div class="modal-footer">
                            <input type="hidden" class="form-control"  name="status" value="2"  />
                            <input type="hidden" class="form-control"  name="invoice_id" value="<?php echo $invoice->id ?>"  />
              ...
              <div class="col-xs-2">   
                  <a target="_blank" href="<?php echo site_url('user/invoice/generate_invoice_pdf/').$invoice->id ?>" class="btn btn-md btn-primary pull-right">Cetak Invoice</a>
              </div>
        </div>
      </div>
      <!--  -->
