  ...
  <section class="content">
    ...
    <div class="invoice">
        ...
        <div class="col-xs-12 table-responsive">
          <table class="table table-striped">
            ...
            <tr>
              ...
              <td><?php echo  number_format($new_quantity) ?></td>
      ...
      <div class="row no-print">
        ...
        <div class="col-xs-2">
                <a href="<?php echo site_url('admin/purchase_order/') ?>" class="btn btn-danger pull-right ">Batal</a>
        </div>
        <div class="col-xs-2">
            <?php echo form_open("admin/invoice/create");?>
                <input type="hidden" value="<?php echo $purchase_order_id; ?>" name="purchase_order_id" >
