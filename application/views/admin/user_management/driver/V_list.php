                ...
                <table class="table table-striped table-bordered table-hover">
                    ...
                    <td>
                        ...
                        <td>
                            ...
                            <button class="btn btn-white btn-danger btn-bold btn-xs" data-toggle="modal" data-target="#deleteModalDriver<?php echo $user->id?>">
                    ...
                    <!-- user -->
                        <!-- Modal Delete-->
                        <div class="modal fade" id="deleteModalDriver<?php echo  $user->id;?>" role="dialog">
