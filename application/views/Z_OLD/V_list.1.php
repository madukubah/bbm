    ...
    <div class="box">
        <div class="box-header">
            <div class="row">
                ...
                <div class="col-md-4">
                    <button type="submit" class="btn  pull-right btn-primary" data-toggle="modal" data-target="#add_material<?php echo $product->id; ?>" >tambah </button>
                    <!-- edit_category-->
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" class="form-control"  name="price_1" value="<?php echo set_value("price_1"); ?>"  />
                                    </div>
                                </div>
                                <!--  -->
                                <!-- - -->
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" class="form-control"  name="price_2" value="<?php echo set_value("price_2" ); ?>" />
            ...
            <div class="table-responsive">
                <table class="table table-striped table-bordered table-hover">
                    ...
                    <tr >
                        ...
                        <th>Nama Material</th>
                        <th>Satuan</th>
                        <th>Harga 1 ( tgl 1-15 )</th>
                        <th>Harga 2 ( tgl 16-30 )</th>
                        <th>Diskon</th>
                        <th>Action</th>
                    </tr>
                    </thead>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                <input type="text" class="form-control"  name="price_1" value="<?php echo set_value("price_1", $material->price_1); ?>"  />
                                            </div>
                                        </div>
                                        <!--  -->
                                        <!-- - -->
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                <input type="text" class="form-control"  name="price_2" value="<?php echo set_value("price_2" , $material->price_2); ?>" />
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                <input type="text" class="form-control"  name="discount" value="<?php echo set_value("discount" , $material->discount); ?>" />
